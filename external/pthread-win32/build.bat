...
msbuild pthread.2013.vcxproj /t:Rebuild /p:Configuration=Debug,Platform=Win32,OutDir=..\lib\win\vc120\Win32\Debug\
msbuild pthread.2013.vcxproj /t:Rebuild /p:Configuration=Release,Platform=Win32,OutDir=..\lib\win\vc120\Win32\Release\
