...
msbuild %PROJECT_ROOT%\zlib.sln /t:Rebuild /p:Configuration=Debug,Platform=x64
msbuild %PROJECT_ROOT%\zlib.sln /t:Rebuild /p:Configuration=Release,Platform=x64
