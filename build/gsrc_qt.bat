...
%GX_TE% -i %PRO_FILE% -o %PRO_FILE% -fp "#__SOURCES_START__" -fs "#__SOURCES_END__" -fd %GX_ROOT%\game\src -fe .cpp -fe .c -fsp "\t../../src" -fss "\\n" -ff GAndroidEntrance.cpp -ff GAndroidActivity.cpp -ff GAndroidDaydream.cpp -ff GD3DContext.cpp -ff GDShader.cpp -ff GMShader.cpp -ff GMTLContext.cpp -ff GXDirectX.cpp -ff GXMetal.cpp -ff glew.c -fsfp "\t#../../src" -fsfs "\\n"
