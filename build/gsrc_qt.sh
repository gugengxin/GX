...
-fe .cpp -fe .c \
-fsp "\t../../src" -fss "\\\n" \
-ff GAndroidEntrance.cpp -ff GAndroidActivity.cpp -ff GAndroidDaydream.cpp -ff GD3DContext.cpp -ff GDShader.cpp -ff GMShader.cpp -ff GMTLContext.cpp -ff GXDirectX.cpp -ff GXMetal.cpp -ff glew.c \
-fsfp "\t#../../src" -fsfs "\\\n"
