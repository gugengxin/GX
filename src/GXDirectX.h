...
#define GX_FILTER_MIN_MAG_POINT			
#define GX_FILTER_MIN_POINT_MAG_LINEAR	
#define GX_FILTER_MIN_LINEAR_MAG_POINT	
#define GX_FILTER_MIN_MAG_LINEAR

#define GX_WARP_REPEAT		
#define GX_WARP_MIRRORED	
#define GX_WARP_CLAMP
